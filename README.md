...
Before starting this application, you need to make sure MongoDB is running: 
```bash
$ mongod
```

You can also connect to MongoDB in another terminal:
```bash
$ mongo
```

And then, you can run your application using npm:
...
In this demo, the `.env` file is created and configured under the root directory, but this file will not be uploaded to GitHub.
